...
class ListController extends ControllerBehavior
{
    ...
    public function makeList($definition = null)
    {
         ...
         */
        $widget = $this->makeWidget(\Wpjscc\Api\Widgets\Lists::class, $columnConfig);
        ...
        $widget->bindEvent('list.extendData', function ($data) {
            return $this->controller->listExtendData($data);
        });
     ...
     * @return  array
     */
    public function listExtendData($data)
    {
        return [];
    }
    ...
    public static function extendListColumns($callback)
    {
        ...
        Event::listen('backend.list.extendColumns', function (\Backend\Classes\WidgetBase $widget) use ($calledClass, $callback) {
