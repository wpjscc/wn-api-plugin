...
class ApiController extends ControllerBase
{
    ...
    public static $apiPluginPrefix;
    public static $apiControllerPrefix;
    public static $apiController;
    public static $pluginCode;
    public static $ui;
    ...
    public function run($url = null)
    {
        ...
        if (!is_null($controllerRequest)) {
            ...
            if (!($controllerRequest['controller'] instanceof Controller)) {
    ...
    protected function getRequestedController($url)
    {
        ...
        if (count($params) >= 2) {
            ...
            if (PluginManager::instance()->isDisabled($pluginCode)) {
                throw new \Wpjscc\Api\Exceptions\NotFoundHttpException();
            }
            ...
            self::$apiPluginPrefix = implode('/', explode('.',strtolower($pluginCode)));
            self::$apiControllerPrefix = implode('/', explode('.',strtolower($pluginCode.'.'.$controller)));
